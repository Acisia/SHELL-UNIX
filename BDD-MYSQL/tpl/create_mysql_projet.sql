...
-- Read Only
-- GRANT SELECT ON *.* TO '${VAL_SCHEMA_USER}'@'127.0.0.1' IDENTIFIED BY 'caa61753f4e0c43d488a0f4b';
-- All privillege
GRANT ALL PRIVILEGES ON ${VAL_SCHEMA}.* TO '${VAL_SCHEMA_USER}'@'127.0.0.1' IDENTIFIED BY 'caa61753f4e0c43d488a0f4b';
